...
contains    
    ...
    subroutine graficar_arbol(self, nombre_archivo)
        ...
        'Titulo [fontname="Comic Sans MS", color=blue shape=Msquare label="Arbol Binario De Busqueda Capas"]' &
        // new_line('a')
    ...
    subroutine generar_grafica(nombre_archivo, codigo)
        ...
        dot_nombre_archivo = "gg/" // trim(nombre_archivo) // ".dot"
        png_nombre_archivo = "gg/" // trim(nombre_archivo) // ".png"
        filepath = 'gg/' // trim(nombre_archivo) 
