...
contains
    ...
    subroutine graficar_matriz(self, filename)
        ...
        io = 1
        fila_aux => self%raiz
        comando = "dot -Gnslimit=2 -Tpng ./gg/"//trim(filename)//".dot -o ./gg/"//trim(filename)//".png"
        open(newunit=io, file="./gg/"//trim(filename)//".dot")
